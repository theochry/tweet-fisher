...
public class Settings extends javax.swing.JFrame  {
    ...
    private void initComponents() {
        ...
        occurencesSpn = new javax.swing.JSpinner();
        jLabel2 = new javax.swing.JLabel();
        timeWindowSpn = new javax.swing.JSpinner();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(timeWindowSpn, javax.swing.GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
                            .addComponent(occurencesSpn))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(occurencesSpn, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3))
                .addGap(1, 1, 1)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(timeWindowSpn, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addGap(18, 18, 18)
                .addComponent(saveBtn)
...
//      occurencesSpn.addChangeListener( new OccurencesListener());
    ...
    {
        return ( Integer ) timeWindowSpn.getValue();
    }
    
    public int getOccurences()
    {
        return ( Integer ) occurencesSpn.getValue();
    }
    ...
    class TimeWindowListener implements ChangeListener
    { 
        public void stateChanged(ChangeEvent e) {
            //_keywordsController.setTimeInterval( ( int ) timeWindowSpn.getValue() );
         }
    }
    class OccurencesListener implements ChangeListener
    {       
        public void stateChanged(ChangeEvent e) {
            // _keywordsController.setOccurences( ( int ) occurencesSpn.getValue() );
         }
    }
    ...
    private javax.swing.JSpinner occurencesSpn;
    private javax.swing.JButton saveBtn;
    private javax.swing.JSpinner timeWindowSpn;
